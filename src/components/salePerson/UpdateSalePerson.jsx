...
import { updateSalesPersons } from '../../actions/salesPersonsAction';
...
const UpdateSalePerson = ({
  ...
  useEffect(() => {
    if (data) {
      ...
      setJoinDate(
        data.doj !== null ? moment(data.doj, 'YYYY-MM-DD') : data.doj
      );
...
UpdateSalePerson.propTypes = {
  Auth: PropTypes.object.isRequired,
  updateSalesPersons: PropTypes.func.isRequired,
};
...
export default connect(mapStateToProps, { updateSalesPersons })(
  UpdateSalePerson
);
