...
const Login = ({
  ...
  const onSubmitPrincipal = (e) => {
    e.preventDefault();
    console.log('inside onSubmitPrincipal');
    if (validate()) {
      loginPrincipal({
        email,
        password,
  ...
  const onSubmitEmployee = (e) => {
    e.preventDefault();
    console.log('inside onSubmitEmployee');
    if (validate()) {
      loginEmployee({
        email,
        password,
...
Login.propTypes = {
  ...
  loginPrincipal: PropTypes.func.isRequired,
