...
import School from '../components/cities/School';
...
import RenewablePackage from '../components/renewablePackage/RenewablePackage';

//Block List
import BlockList from '../components/blockList/BlockList';
import UnblockForm from '../components/blockList/UnblockForm';
import ChangePassword from '../components/changePassword/ChangePassword';

//Student
import AddStudent from '../components/studentAdmission/AddStudent';
import StudentListing from '../components/studentAdmission/StudentListing';
export const routes = [
  { path: '/virtualsoft/admin/dashboards', Component: Dashboard },
  { path: `/virtualsoft/admin/school/add-school`, Component: AddSchool },
  { path: `/virtualsoft/admin/school/detail`, Component: ViewSchool },

  { path: `/virtualsoft/admin/dashboards/schools`, Component: SchoolDashboard },
  { path: `/virtualsoft/admin/dashboards/cities`, Component: Cities },
  {
    path: `/virtualsoft/admin/dashboards/cities/schools`,
    Component: CitiesSchools,
  },
  {
    path: `/virtualsoft/admin/dashboards/cities/schools/school`,
    Component: School,
  },
  { path: `/virtualsoft/admin/dashboards/countries`, Component: Countries },

  {
    path: `/virtualsoft/admin/school/school-listing`,
    Component: SchoolListing,
  },
  { path: `/virtualsoft/admin/message`, Component: Messages },

  { path: '/virtualsoft/admin/usermanagement', Component: Users },
  { path: '/virtualsoft/admin/income', Component: Income },
  { path: '/virtualsoft/admin/income/details', Component: Details },
  { path: '/virtualsoft/admin/packages', Component: Packages },
  { path: '/virtualsoft/admin/renewable-package', Component: RenewablePackage },

  { path: '/virtualsoft/admin/addPackage', Component: AddPackage },

  { path: '/virtualsoft/admin/student-management', Component: Students },
  { path: '/virtualsoft/admin/block-list', Component: BlockList },
  { path: '/virtualsoft/admin/unblock', Component: UnblockForm },
  { path: '/virtualsoft/admin/change-password', Component: ChangePassword },

  { path: '/virtualsoft/admin/addStudent', Component: AddStudent },
  { path: '/virtualsoft/admin/student-listing', Component: StudentListing },
