...

  {
    ...
    Items: [
...

      {
        ...
        roleType: true,
        path: `${process.env.PUBLIC_URL}/student-management`,
        icon: Layers,
...

      {
        ...
        children: [
          {
            path: `${process.env.PUBLIC_URL}/school/add-school`,
            title: 'Add School',
            type: 'link',
          },
          {
            path: `${process.env.PUBLIC_URL}/virtualsoft/admin/school/school-listing`,
...

      {
        role: 'message',
        roleType: true,
        path: `${process.env.PUBLIC_URL}/virtualsoft/admin/income`,
        icon: DollarSign,
        title: 'Income',
        type: 'link',
      },

      {
        role: 'message',
        roleType: true,
        path: `${process.env.PUBLIC_URL}/virtualsoft/admin/packages`,
        icon: Package,
        title: 'Packages',
        type: 'link',
      },

      {
        ...
        children: [
          ...
          {
            path: `${process.env.PUBLIC_URL}/block-list`,
            title: 'Block List',
            type: 'link',
          },
          {
