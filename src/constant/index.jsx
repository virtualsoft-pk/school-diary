export const SilverPackage = 'Silver Package';
export const GoldPackage = 'Gold Package  ';
export const PlatinumPackage = 'Platinum Package';
export const TotalPackage = 'Total Earning';
export const NewPass = 'New Password';
export const OldPass = 'Old Password';
